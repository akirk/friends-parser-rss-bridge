This Version of RSS Bridge has been forked and modified to be included in the [Friends Parser RSS Bridge WordPress plugin](https://github.com/akirk/friends-parser-rss-bridge).
